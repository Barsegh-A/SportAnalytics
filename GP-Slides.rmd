...
a game selected at random from the schedule, is achieved when the best team wins all games. Relative entropy, $R = \frac{H}{HM}$, measures the degree of uncertainty about which team might have won a randomly-selected game, relative to the maximum uncertainty possible.
